...
const Footer = () => {
  ...
  return (
    <footer id='Footer' className="bg-white py-6 border-t border-gray-200" ref={ref}>
      <motion.div
          ...
          <div className="text-center md:flex justify-between lg:text-right">
            ...
            <div className="flex justify-center lg:justify-end space-x-4 mt-4">
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer">
                <button className="border border-gray-300 rounded-full py-1 px-3 text-base">Instagram</button>
              </a>
              <a href="https://whatsapp.com" target="_blank" rel="noopener noreferrer">
                <button className="border border-gray-300 rounded-full py-1 px-3 text-base">Whatsapp</button>
              </a>
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer">
                <button className="border border-gray-300 rounded-full py-1 px-3 text-base">Facebook</button>
              </a>
            </div>
          </div>
        </div>
      ...
      <div className="mt-6 border-t border-gray-200 pt-4 flex flex-col lg:flex-row justify-between px-24 items-center text-lg text-gray-500">
        ...
        <div>
          ...
          <p className="text-center lg:text-right text-green-600">Created by Saksham Gupta</p>
        </div>
      </div>
    </footer>
  );
