...
function Hero() {
  return (
    <section className='relative bg-cover w-screen  bg-center h-screen md:h-[80vh] flex  ' style={{
      ...
      <div className='z-10 mx-auto mt-12 px-8 ' >
        ...
        <div className='flex mb-5 items-center justify-center' >
          <Link
            href="#"
            className="bg-[#007F40] hover:bg-green-700  text-white font-bold py-3 px-8 rounded-sm text-xl hover:px-20 transition-all  "
          >
            REGISTER NOW
          </Link>
        </div>
